  ...
  return (
    ...
    >
      ...
      <motion.div style={{ opacity }} className="relative z-10 text-center text-white px-6">
        ...
        <h1 className="text-7xl md:text-9xl lg:text-[12rem] font-bold leading-none mb-6" style={{ fontFamily: "'DIN Condensed', 'Barlow Condensed', sans-serif", letterSpacing: '0.6em' }}>
          BATRAI
        </h1>
